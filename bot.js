...
client.on('message', message => {
    ...
    var log = message.guild.channels.find('name', 'system-log');
...
client.on("guildMemberAdd", member => {
  client.channels.find('id', '592108404282097720').send(` **Welcome To .. Server**  `)
});
/////////
...
/////
client.login('NTkyMTA4NjE5MzY2MDA2ODcy.XQ6iTQ.T-AOBgUndrQjfArGO_SGRpt7RcA');
